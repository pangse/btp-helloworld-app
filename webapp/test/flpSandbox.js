		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapbtphellowordui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtphellowordui5-display": {
								"semanticObject": "sapbtphellowordui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.hellowordui5",
									"url": sap.ui.require.toUrl("sap/btp/hellowordui5")
								}
							}
						}
					}
